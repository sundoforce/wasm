...
var wasmBinaryFile = 'validate.wasm';
...
var asmGlobalArg = {};
var asmLibraryArg = { "UpdateHostAboutError": _UpdateHostAboutError, "__handle_stack_overflow": ___handle_stack_overflow, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_resize_heap": _emscripten_resize_heap, "memory": wasmMemory, "table": wasmTable };
var asm = createWasm();
Module["asm"] = asm;
/** @type {function(...*):?} */
...
/** @type {function(...*):?} */
var _ValidateName = Module["_ValidateName"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["ValidateName"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _ValidateCategory = Module["_ValidateCategory"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["ValidateCategory"].apply(null, arguments)
};
